...
-- 根据玩家和目标状态判断是否进入战斗状态。
local function isFight(me, player)
...
-- 找到附近的弱玩家
local function findWeakNearPlayer(me)
...
local function adjustPosition(n1, n2)
...
-- 向目标移动，在攻击范围，则进行攻击
local function moveToTarget(me, player)
...
-- 从目标玩家那里逃跑
local function runaway(me, player)
